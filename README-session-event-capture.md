...
Roadmap items 1 and 2 are done. The formula validated here is the input to
item 5 (zone primitive in the live path) and then item 6 (commitment), which is
the shortest route from this branch to something visible. See the [main
README](README.md#roadmap) — the closing subsection there argues for taking
that route ahead of the analytics-boundary work listed as items 3 and 4.
